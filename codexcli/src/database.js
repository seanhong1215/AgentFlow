...
function migrateDatabase() {
  ensureColumn('orders', 'ecpay_merchant_trade_no', 'TEXT');
  ensureColumn('orders', 'ecpay_trade_no', 'TEXT');
  ensureColumn('orders', 'ecpay_payment_type', 'TEXT');
  ensureColumn('orders', 'ecpay_payment_date', 'TEXT');
  ensureColumn('orders', 'ecpay_trade_status', 'TEXT');
  ensureColumn('orders', 'ecpay_query_raw', 'TEXT');
  ensureColumn('orders', 'payment_checked_at', 'TEXT');
